...
public class BigqueryTablesApiTest {
  ...
  public void itAssemblesTables() {
    ...
    Table table = bqApi.assembleTable(ConfigLoader.getTableInserterConfig().tables.get(0));
    ...
    table = bqApi.assembleTable(ConfigLoader.getTableInserterConfig().tables.get(1));
    assertThat(table.getTableReference().getDatasetId(), is("dataset"));
